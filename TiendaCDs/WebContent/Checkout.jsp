<%@ page session="true" import="java.util.*, Servlet.CD"
	import="Servlet.CDdb" import="Servlet.Cartdb"%>
<html>
<head>
...
<body bgcolor="#33CCFF">
	...
	<center>
		...
		<p>
			<%
				Cartdb carrito = new Cartdb();
				System.out.println(session.getId() + " " + amount);
				carrito.putcart(session.getId(), Float.parseFloat(amount));
			%>
